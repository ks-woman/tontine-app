...
@section('content')
    <div class="container-fluid">
                                    ...
                                    @forelse($participants as $participant)
                                        <tr>
                                            <td>{{ $participant->prenom }}
                                                {{ $participant->nom }}<br><small>{{ $participant->email }}</small>
                                                </br>
                                            <td>
        ...
        @else
            <div class="alert alert-danger">Tontine introuvable.</div>
            <a href="{{ route('tontines.index') }}" class="btn btn-secondary">Retour à la liste</a>
        @endif
    </div>
@endsection
